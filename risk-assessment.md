...
This proposal does not increase any existing VM limits, minimizing the risk of increase to worst-case validation performance (preventing any increase in node operation costs).
